...
@WebServlet("/personal-house")
public class PersonalHouseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        context.setVariable("user_personal_houses", houseService.getUserHouses(user.getId()));
        ThymeleafUtil.process("personal-house.html", context, resp.getWriter());
    }
}
